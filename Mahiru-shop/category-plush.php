...
$category = 'Plush'; // tùy thuộc vào cách lưu trữ trong database
...
<head>
    ...
    <title>Plush Products - Mahiru Shop</title>
...
<body>
    ...
    <main>
        ...
        <div class="pagination">
            <?php if ($page > 1): ?>
                <a href="category-plush.php?page=<?php echo $page - 1; ?>">&laquo; Previous</a>
            <?php endif; ?>
            <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                <a href="category-plush.php?page=<?php echo $i; ?>" class="<?php echo ($i === $page) ? 'active' : ''; ?>"><?php echo $i; ?></a>
            <?php endfor; ?>
            <?php if ($page < $totalPages): ?>
                <a href="category-plush.php?page=<?php echo $page + 1; ?>">Next &raquo;</a>
            <?php endif; ?>
        </div>
    </main>
