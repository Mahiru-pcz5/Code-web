...
$countSql = "SELECT COUNT(*) FROM products WHERE category = 'gundam' AND price <= :price";
if (!empty($searchName)) {
...
$sql = "SELECT * FROM products WHERE category = 'gundam' AND price <= :price";
if (!empty($searchName)) {
...
<head>
    ...
    <title>Mahiru Shop - Gundam</title>
            ...
            <div class="container">
                ...
                <div class="search-bar">
                    <form action="search.php" method="GET">
                        ...
                        <input type="hidden" name="category" value="gundam" />
    ...
    <main>
        <div class="container">
            <div class="filter-sidebar">
                <form action="category_acc_gundam.php" method="GET">
                    <h3>Name:</h3>
        ...
        <div class="pagination">
            <?php if ($page > 1): ?>
                <a href="category_acc_gundam.php?page=<?php echo $page - 1; ?>&name=<?php echo urlencode($searchName); ?>&price=<?php echo $priceRange; ?>">« Previous</a>
            <?php endif; ?>
            <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                <a href="category_acc_gundam.php?page=<?php echo $i; ?>&name=<?php echo urlencode($searchName); ?>&price=<?php echo $priceRange; ?>" class="<?php echo ($i === $page) ? 'active' : ''; ?>"><?php echo $i; ?></a>
            <?php endfor; ?>
            <?php if ($page < $totalPages): ?>
                <a href="category_acc_gundam.php?page=<?php echo $page + 1; ?>&name=<?php echo urlencode($searchName); ?>&price=<?php echo $priceRange; ?>">Next »</a>
            <?php endif; ?>
        </div>
    </main>
