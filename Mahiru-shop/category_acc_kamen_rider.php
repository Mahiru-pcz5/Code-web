...
$countSql = "SELECT COUNT(*) FROM products WHERE category = 'kamen_rider' AND price <= :price";
if (!empty($searchName)) {
...
<head>
    ...
    <title>Mahiru Shop - Kamen Rider</title>
...
<body>
            ...
            <div class="container">
                ...
                <div class="search-bar">
                    <form action="search.php" method="GET">
                        ...
                        <input type="hidden" name="category" value="kamen_rider" />
    ...
    <main>
        ...
        <div class="pagination">
            <?php if ($page > 1): ?>
                <a href="category_acc_kamen_rider.php?page=<?php echo $page - 1; ?>&name=<?php echo urlencode($searchName); ?>&price=<?php echo $priceRange; ?>">« Previous</a>
            <?php endif; ?>
            <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                <a href="category_acc_kamen_rider.php?page=<?php echo $i; ?>&name=<?php echo urlencode($searchName); ?>&price=<?php echo $priceRange; ?>" class="<?php echo ($i === $page) ? 'active' : ''; ?>"><?php echo $i; ?></a>
            <?php endfor; ?>
            <?php if ($page < $totalPages): ?>
                <a href="category_acc_kamen_rider.php?page=<?php echo $page + 1; ?>&name=<?php echo urlencode($searchName); ?>&price=<?php echo $priceRange; ?>">Next »</a>
            <?php endif; ?>
        </div>
    </main>
